...
#define ULTRASONIC_FORW_Pin GPIO_PIN_4
#define ULTRASONIC_FORW_GPIO_Port GPIOA
#define ULTRASONIC_BACK_Pin GPIO_PIN_5
#define ULTRASONIC_BACK_GPIO_Port GPIOA
